                    ...
                    <div class="panel-content">
                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="Area">Sede</label>
                                    <input type="text" id="Sede" class="form-control" disabled v-model="datosUsuario.sede">
                                </div>
                            </div>
...
export default {
    ...
    data(){
        return {
            session: null,
            datosUsuario: {nombre:'', apellido:'', documento:'', email:'', cargo: '', area: '', telefono: '', sede: ''},
    ...
    mounted(){
        ...
        this.datosUsuario.sede = this.session.sede.name;
    },
    methods:{
        validarCampos(){
