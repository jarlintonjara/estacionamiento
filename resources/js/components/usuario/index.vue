                                ...
                                <tbody>
                                    <tr v-for="user in users" :key="user.id">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success" title="Resetear Contraseña" @click="resetPassword(user.id)">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div v-if="datos.role_id=='3'" class="form-group col-md-4" style="display: none;">
...
export default {
    ...
    methods:{
        ...
        resetPassword(id) {
            ...
            .then(async(res) => {
                if(res.isConfirmed) {
                    await this.axios.post('/api/resetSimplePassword', {id_user: id})
                        .then((res) => {
                            this.$swal.fire({
                                icon: 'success',
